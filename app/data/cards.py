...
ROGUE_CARDS = {
    "tengen": {"name": "天元", "desc": "AI 开局必下天元，随后 2 手只能落在天元 5×5 菱形区域内", "icon": "◎"},
    ...
    "slip": {"name": "手滑了", "desc": "AI 有 12% 概率手滑到相邻的点位", "icon": "😾"},
    "blackhole": {"name": "黑洞", "desc": "棋盘中心 13 子区域整局对 AI 禁入", "icon": "🕳️"},
    "exchange": {"name": "乾坤挪移", "desc": "主动技能：限 1 次，将对方一颗棋子摆动到你指定的空点", "icon": "🔄", "uses": 1},
    "fog": {"name": "战争迷雾", "desc": "AI 前 11 手每手前会刷新一个 3×3 禁区遮罩；之后每回合随机封锁 2 个 AI 禁着点", "icon": "🌫️"},
    "gravity": {"name": "星位引力", "desc": "AI 前 6 手必定下在星位", "icon": "🌃"},
    "golden_corner": {"name": "黄金角", "desc": "随机封锁一角 4×4 区域，AI 整局禁入", "icon": "🪙"},
    "sansan": {"name": "三三开局", "desc": "AI 前 3 手必定下在角部 3×3 区域", "icon": "◎"},
    "shadow": {"name": "影子", "desc": "AI 整局有 18% 概率紧跟自己的上一手", "icon": "👁"},
    ...
    "god_hand": {"name": "神之一手", "desc": "踩中隐藏菱形区，周围 5×5 内随机爆出 3 颗己棋，只会落在空点", "icon": "✨"},
    "sansan_trap": {"name": "三三陷阱", "desc": "只要 AI 下在四个三三点之一，就会在该三三点相邻交叉点生成 1 颗我方棋，不占用落子权", "icon": "🪤"},
    "corner_helper": {"name": "守角辅助", "desc": "每个角各算一次：任一角的 5×5 区域里有 4 颗己子时，就会在那个角补 1 颗援军", "icon": "🏯"},
    "sanrensei": {"name": "三连星", "desc": "若你前三手都下在星位，会在额外两颗未落子星位赠送我方棋", "icon": "⭐"},
    "no_regret": {"name": "永不悔棋", "desc": "禁用悔棋；对方落子后有 8% 概率在你的下一手最佳点位自动赠送一子，不占用手动着子机会", "icon": "🚫"},
    "quickthink": {"name": "快速思考", "desc": "2 秒内落子可追加 1 秒连击窗口；超时视为虚手；选中后禁用推荐点位与悔棋", "icon": "⚡"},
    "foolish_wisdom": {"name": "大智若愚", "desc": "摆出愚形，附近 5×5 内随机长出 2 颗己棋", "icon": "🧠"},
    "five_in_row": {"name": "五子连珠", "desc": "这是五子棋，不是围棋。每当我方横、竖、斜正好连成 5 颗同色棋，就会优先在首尾补子；若首尾被堵住，则改在两端附近补子，并在连线附近再补 2 颗援军", "icon": "🎯"},
